...
/* Análisis principal de somnolencia */
void analyze_drowsiness(float* left_eye_data, int left_count,
    ...
    /* Conversión de arrays a estructuras Point2f */
    ...
    /* Clasificación de estado de boca */
    if (result->mar >= 0.70f) {
    ...
    /* Cálculo de parpadeos por minuto */
